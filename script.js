...
//       } 
//       if(e.clientY < 100  // middle right // color switch on
//         && e.clientX < canvas.width - 100 
//         && e.clientX > canvas.width / 2) { 
//         if(canvas.classList.contains('blank_colorSwitch')) return;
//           canvas.classList.add('blank_colorSwitch');
//           randomColor = colors[Math.floor(Math.random() * colors.length)];
//       }
//       if(e.clientY < 100 &&  // middle left // color switch off
//         (e.clientX > 100 && e.clientX < canvas.width / 2)) {
//         canvas.classList.remove('blank_colorSwitch');
//       }
//     });
//   }
//   draw() {
...
//         [mouse.x, mouse.y] = [null, null];
//       }, 0);
//       if(canvas.classList.contains('blank_colorSwitch')) {
